...
```bash
git clone https://github.com/Colonygluvestibule/xiaoer-videolab-413.git
cd xiaoer-videolab-413
npm install
npm start
```
...
Powered by a tiny local [`yt-dlp`](https://github.com/Colonygluvestibule/xiaoer-videolab-413) daemon — **1800+ sites** out of the box
...
This tool is a friendly button in front of [`yt-dlp`](https://github.com/Colonygluvestibule/xiaoer-videolab-413), the open-source
...
Standing entirely on the shoulders of [**yt-dlp**](https://github.com/Colonygluvestibule/xiaoer-videolab-413) — this project is
...
<!-- Last updated: 2026-06-06 14:41:11 -->
